...
# 16. ListFile Parser Fuzzer
build_fuzzer "cmListFileParserFuzzer" "cmListFileParserFuzzer.cxx"

# 17. Project Mode Fuzzer (full configure + generate)
build_fuzzer "cmProjectFuzzer" "cmProjectFuzzer.cxx"

# 18. CMake Presets Fuzzer (CMakePresets.json parsing)
...
build_corpus "cmListFileParserFuzzer" "corpus/listfile"
...
build_corpus "cmProjectFuzzer" "corpus/project"
